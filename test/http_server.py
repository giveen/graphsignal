...
class HttpTestServer(threading.Thread):
    ...
    def get_request_path(self):
        return RequestHandler.request_path
...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        # Recorded for the same reason do_POST records it: a test that asserts
        # WHICH endpoint was called needs the path, and a GET-only client has
        # no body to identify itself by.
        RequestHandler.request_path = self.path
